...
model_1 = lm(rating~tempo+time_signature+mode+speechiness+ track_explicit+genre+track_duration+danceability+energy+key+loudness+ interactive+song_intensity,geners_modify_2)
...
write.csv(submissionFile, 'model_3.csv',row.names = F)
head(songs_test)
head(geners_modify)
dim(geners_modify)
