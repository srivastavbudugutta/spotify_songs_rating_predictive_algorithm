...
full_mod = lm(rating~genre+ track_duration+ track_explicit+ danceability+ energy+ key+ 
                   ...
                   instrumental_energy+
                   individual_group+
                   performer_new,performer_rating_2)
...
x = model.matrix(rating~genre+ track_duration+ track_explicit+ danceability+ energy+ key+ 
                   ...
                   instrumental_energy+
                   individual_group+
                   performer_new,data=performer_rating_2)
y = performer_rating_2$rating
...
model_1 = lm(rating~performer_new+
               danceability+
               speechiness+
               loudness+
               valence+
...
write.csv(submissionFile, 'model_4_3.csv',row.names = F)
# head(songs_test)
# head(geners_modify)
# dim(geners_modify)
