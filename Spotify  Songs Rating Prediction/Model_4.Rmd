...
full_mod = lm(rating~tempo+time_signature+mode+speechiness+ track_explicit+genre+track_duration+danceability+energy+key+loudness+ interactive+song_intensity+acoustic_energy+instrumental_energy+liveenergy,geners_modify_2)
